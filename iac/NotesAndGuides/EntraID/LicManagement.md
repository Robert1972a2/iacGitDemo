...
- [License Management with Microsoft Graph PowerShell SDK](#license-management-with-microsoft-graph-powershell-sdk)
...
$lic = @{ SkuId = $licSKU.SkuId; DisabledPlans = $disabledServices.ServicePlanId }
