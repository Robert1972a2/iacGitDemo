...
param VMAppGallery string = '/subscriptions/097d177e-53e4-4f46-8807-96576bb5dde0/resourceGroups/RG-Gallery/providers/Microsoft.Compute/galleries/trgComputeGallery'
...
resource VM 'Microsoft.Compute/virtualMachines@2025-11-01' = {
  ...
  properties: {
    ...
    applicationProfile: {
      galleryApplications: [
        {
          packageReferenceId: '${VMAppGallery}/applications/SSMS/versions/0.1.0'
          treatFailureAsDeploymentFailure: false
          enableAutomaticUpgrade: false
          order: 1
        }
        {
          packageReferenceId: '${VMAppGallery}/applications/PowerShell7-winget/versions/latest'
          treatFailureAsDeploymentFailure: false
          enableAutomaticUpgrade: false
          order: 2
        }
